...
$(BINDIR)/$(TARGET): $(OBJDIR)/shared.o $(OBJDIR)/main.o $(OBJDIR)/probe.o $(OBJDIR)/thread.o $(OBJDIR)/event_map.o $(OBJDIR)/perf_event.o $(OBJDIR)/mmap_page.o $(OBJDIR)/output.o $(OBJDIR)/probe_buff.o
